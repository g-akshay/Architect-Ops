...
```bash
cp .architect-ops/CLAUDE.md ./CLAUDE.md          # or GEMINI.md / AGENTS.md
...
```
architect-ops/
├── CLAUDE.md                    # Drop-in AI agent config (Claude Code)
├── ARCHITECTURE.md              # Your system rules template
...
| Claude Code | ✅ Native |
| Gemini CLI | ✅ Native |
| Cursor | ✅ Via `CLAUDE.md` |
| GitHub Copilot Workspace | ✅ Via `AGENTS.md` |
| OpenCode | ✅ Via slash commands |
| Any agent reading markdown docs | ✅ Universal |
